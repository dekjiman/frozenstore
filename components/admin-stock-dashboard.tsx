...
export function AdminStockDashboard() {
  ...
  return <div className="mx-auto max-w-7xl">
    <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between"><div><p className="text-sm font-semibold text-[var(--brand-600)]">Ringkasan gudang</p><h1 className="mt-1 font-serif text-4xl tracking-tight">Stok terkini</h1><p className="mt-2 text-sm text-stone-500">Pantau ketersediaan produk dan prioritaskan restock sebelum kehabisan.</p></div><Link href="/admin/stok/masuk" className="inline-flex h-11 items-center justify-center rounded-full bg-stone-900 px-5 text-sm font-semibold text-white">Catat stok masuk</Link></div>
