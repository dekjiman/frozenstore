    ...
    <div className="mt-8">
      ...
      <div className="mt-6 rounded-2xl border border-stone-200 p-5">
        <h3 className="flex items-center gap-2 text-sm font-semibold text-stone-900">
          <MapPin aria-hidden="true" size={17} className="text-[var(--brand-600)]" /> Alamat pengiriman
        </h3>
      ...
      <div className="mt-6 rounded-2xl border border-stone-200 p-5">
        <h3 className="flex items-center gap-2 text-sm font-semibold text-stone-900">
          <PackageCheck aria-hidden="true" size={17} className="text-[var(--brand-600)]" /> Detail pesanan
        </h3>
      ...
      <div className="mt-7 flex flex-col gap-3 sm:flex-row">
        <Link href="/akun/pesanan" className="flex flex-1 items-center justify-center rounded-full bg-stone-900 px-5 py-3 text-sm font-semibold text-white hover:bg-[var(--brand-700)]">
