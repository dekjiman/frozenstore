        ...
        <Container className="pt-6 pb-4">
          ...
          <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
            ...
            <a
              ...
              className="inline-flex h-10 shrink-0 items-center gap-2 whitespace-nowrap rounded-full bg-[var(--brand-600)] px-5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[var(--brand-700)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-600)]/40 focus-visible:ring-offset-2"
            >
