        ...
        <Container className="pt-6 pb-4">
          ...
          <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
            ...
            <a
              ...
              className="inline-flex h-10 shrink-0 items-center gap-2 whitespace-nowrap rounded-lg border border-[var(--brand-600)]/25 bg-white px-4 text-sm font-semibold text-[var(--brand-700)] transition-colors hover:bg-[var(--brand-50)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-600)]/30"
            >
              <svg className="size-4 text-[var(--brand-600)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
